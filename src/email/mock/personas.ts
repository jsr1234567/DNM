...
export const personas: readonly PersonaDefinition[] = [
  ...
  },
  {
    ...
    messages: [
      ...
      { id: "school-3", threadId: "school-dismissal", dayOffset: -1, direction: "outgoing", correspondent: "Riverside School <office@school.example.test>", subject: "Re: Reminder: early dismissal", body: "I cannot leave my client call before 2pm, so I still need trusted pickup coverage from 12:30 to 2pm." },
